...
+ (NSString *)sha256WithStringWithBase64:(NSString*)orignailString  //20140217
{
    NSString *base64EncodedString = [orignailString base64EncodedString];
    NSString *serverCertificateDataHash = [CocoaSecurity SHA256String:base64EncodedString];
    
    return serverCertificateDataHash;
}
+ (NSString*) SHA256String:(NSString *)hashString  //20140217
{
